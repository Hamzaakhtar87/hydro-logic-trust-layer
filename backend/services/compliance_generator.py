...
class ComplianceGenerator:
    ...
    # Environmental factors per inference event (estimates based on data center research)
    ...
    def generate_pdf_report(
        ...
        if REPORTLAB_AVAILABLE:
            ...
            story.append(Paragraph("This report meets EU AI Act Article 52 & 65 requirements for environmental transparency", footer_style))
